# FindTensorRT.cmake
#
# Locates NVIDIA TensorRT (https://developer.nvidia.com/tensorrt).
#
# Defines:
...
#   TensorRT::nvinfer       - Imported target for libnvinfer
#   TensorRT::nvonnxparser  - Imported target for libnvonnxparser
...
# Parse version from NvInferVersion.h
if(TensorRT_INCLUDE_DIR AND EXISTS "${TensorRT_INCLUDE_DIR}/NvInferVersion.h")
    ...
    file(STRINGS "${TensorRT_INCLUDE_DIR}/NvInferVersion.h" _trt_patch
        REGEX "#define NV_TENSORRT_PATCH")
